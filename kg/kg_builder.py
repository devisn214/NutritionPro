...
class NutritionKGBuilder:
    ...
    def create_indexes(self):
        ...
        self.run_query("CREATE INDEX IF NOT EXISTS FOR (r:RSID) ON (r.id)")
    ...
    def create_gene_nodes_from_genenutrient(self, csv):
        ...
        for _, r in df.iterrows():
            ...
            self.run_query("""
                ...
                MERGE (r:RSID {id:$rsid})

                SET r.genotype=$genotype

                MERGE (g)-[:HAS_VARIANT]->(r)
...
if __name__ == "__main__":
    ...
    print("Success: Knowledge Graph Built with Genotype-aware Nutrigenomics.")
